...
public class TwitchClient {
    private static final String TOKEN = "Bearer 7r5ixqc90hjf6k68b6mo838ypy7hcy";
    private static final String CLIENT_ID = "39ml6uziwuw7ze7dpefcbsbcbtcwhl";
    ...
    // Return items for a specific type or all types
